...
RUN sed -i 's/#ServerName www.example.com:80/ServerName 172.20.50.205:80/g' /etc/httpd/conf/httpd.conf
RUN sed -i 's/ServerAdmin root@localhost/ServerAdmin root@172.20.50.205/g' /etc/httpd/conf/httpd.conf
